...
type MailDepositRegistrationRequest struct {
	...
	RemitMethodBank        string `json:"Remit_Method_Bank,omitempty"`
	RemitMethodSevenatm    string `json:"Remit_Method_Sevenatm,omitempty"`
	SevenatmPaymentTermDay int    `json:"Sevenatm_Payment_Term_Day,omitempty"`
	RemitMethodAmazongift  string `json:"Remit_Method_Amazongift,omitempty"`
	RemitMethodAupay       string `json:"Remit_Method_Aupay,omitempty"`
