...
func TestDeferred_ModifyTransaction(t *testing.T) {
	type args struct {
		ctx context.Context
		req *ModifyRequest
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := c.ModifyTransaction(tt.args.ctx, tt.args.req)
			if (err != nil) != tt.wantErr {
				t.Errorf("c.ModifyTransaction() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
